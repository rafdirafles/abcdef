...
<!-- Mirrored from keenthemes.com/metronic/preview/demo2/custom/pages/user/login-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Sep 2019 06:29:31 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8"/>

        <title>A-SIK | Login Page</title>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700">        <!--end::Fonts -->
                    ...
                    <!--begin::Page Custom Styles(used by this page) -->
                             <link href="{{ asset('template/assets/css/pages/login/login-3.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="{{ asset('template/assets/media/logos/logoakpol2.png')}}" />
    </head>
    <!-- end::Head -->
			...
			<div class="kt-login__container">
						...
						<div class="input-group">
                            ...
                            @if ($errors->has('nip_nrp') || $errors->has('email'))
                                <span class="invalid-feedback">
                                    <strong>{{ $errors->first('nip_nrp') ?: $errors->first('email') }}</strong>
                                </span>
                            @endif
                        </div>
						<div class="input-group">
				...
				<div class="kt-login__forgot">
                    ...
                    <form class="kt-form" action="{{ route('password.email') }}" method="post">
                        @csrf
						<div class="input-group">
                            {{-- <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" type="text" placeholder="Email" id="kt_email" autocomplete="off">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    	...
    	<!--begin::Global Theme Bundle(used by all pages) -->
				...
				<!--end::Global Theme Bundle -->
                    ...
                    <!--begin::Page Scripts(used by this page) -->
                            <script src="{{ asset('template/assets/js/pages/custom/login/login-general.js')}}" type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->

<!-- Mirrored from keenthemes.com/metronic/preview/demo2/custom/pages/user/login-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Sep 2019 06:29:34 GMT -->
</html>
