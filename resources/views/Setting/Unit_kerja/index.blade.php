            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                <div class="kt-container ">
                    ...
                    <h3 class="kt-subheader__title">MASTER</h3>
                        ...
                        <span class="kt-subheader__desc">Unit Kerja</span>
                    </div>
                </div>
            </div>
            <!-- end:: Content Head -->
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-wrapper">
                                <div class="kt-portlet__head-actions">
                                    <button href="#" class="btn btn-brand btn-elevate btn-icon-sm klik-tambah" data-toggle="modal" data-target="#modal-add-unit-kerja"><i class="la la-plus"></i> Tambah Unit Kerja</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="jdlbrevet">Tambah Unit Kerja</h5>
            ...
            <form class="form-horizontal" data-toggle="validator">
                ...
                <div class="modal-body">
                    <div class="form-group">
                            <label class="control-label" for="title">Unit Kerja </label>
                            <input type="text" name="nama_unit_kerja" id="nama_unit_kerja" class="form-control" required />

                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btn_simpan_unit_kerja">Simpan</button>
                </div>
            </form>
            <!-- form -->
        </div>
...
<div class="modal fade" id="edit-item-unit_kerja" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="jdlbrevet">Edit Unit Kerja</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                    <form data-toggle="validator" >
                        ...
                        <div class="modal-footer">
                                <button class="btn btn-primary edit-unit_kerja">Simpan</button>
                        </div>
                    </form>
