                                    ...
                                    <div class="kt-portlet__body ">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="form-control" name="is_status" required>
                                                        <option value="">pilih</option>
                                                        <option {{($datas->is_status == "1" ) ? 'selected' : "" }} value="1">Aktif</option>
                                                        <option  {{($datas->is_status == "0" ) ? 'selected' : "" }}  value="0">Non Aktif</option>
 ...
 $(document).ready(function () {
    ...
    $("#contactform").validate({
        ...
        submitHandler: function (form) {
            ...
            var is_status= $(".pegawai").find("select[name='is_status']").val();
            // jk
            ...
            // foto
            var level= $(".pegawai").find("select[name=level]").val();
